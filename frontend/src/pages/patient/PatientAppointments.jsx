...
// Fetch /appointments/ — render list with date, reason, StatusBadge. For in_progress appointments show Join Call button linking to /patient/appointments/:id/call
