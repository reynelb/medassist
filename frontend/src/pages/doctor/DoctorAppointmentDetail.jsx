...
// Fetch /appointments/:id — show patient summary card, scheduled time, reason, status. Actions: Start Call (POST /appointments/:id/start), View Transcript, View Report
