...
// Poll GET /reports/:id until status=draft. Render editable form (chief complaint, symptoms tags, diagnosis, treatment, medications rows, follow-up date, notes). PATCH /reports/:id on save. POST /reports/:id/confirm to finalise
