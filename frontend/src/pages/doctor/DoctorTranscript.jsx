...
// Poll GET /transcripts/:id every 3s until status=ready. Render raw_text with speaker labels. Button: Generate Report (POST /reports/:id/generate)

export default function DoctorTranscript() {
  return (
    <Layout>
