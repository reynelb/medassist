...
// Integrate WebRTC via Daily.co iframe or simple-peer. Record audio during call. On end: POST audio blob to /transcripts/calls/:id/recording, then redirect to transcript page
